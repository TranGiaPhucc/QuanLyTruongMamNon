...
public class SQL {
    private static String ip = "192.168.137.1";      //192.168.1.189
    ...
    public boolean isUserExist(int username, String password) {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("select * from HocSinhs where MaHocSinh = " + username + " and MatKhau = '" + md5(password) + "'");
